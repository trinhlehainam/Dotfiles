...
-- INFO: https://github.com/Saecki/crates.nvim/wiki/Documentation-v0.5.0
...
vim.keymap.set(
  ...
  { desc = '[C]rates Open [D]ocumentation' }
)
vim.keymap.set('n', '<leader>cC', crates.open_crates_io, { desc = '[C]rates Open [C]rates' })

-- INFO: https://github.com/Saecki/crates.nvim/wiki/Documentation-v0.5.0#show-appropriate-documentation-in-cargotoml
